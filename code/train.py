...
def input_fn(file_names):
  dataset = tf.data.TFRecordDataset(filenames=file_names, num_parallel_reads=40)
...
if __name__ == '__main__':
    ...
    model = tf.estimator.Estimator(model_fn=model_fn, params={"learning_rate": 1e-4}, model_dir="./model5/")
    count = 0
    while count < 100000:
